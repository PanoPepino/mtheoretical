...
class Example_Eq_Metric(Scene):
    def construct(self):
        ...
        keys_tex= VGroup(*[Tex(key, color= BLACK, font_size= 20) for key in keys]).arrange(DOWN, aligned_edge= LEFT, buff= 0.1) # to print the keys
...
class Example_Eq_Cosmo(Scene):
    def construct(self):
        ...
        keys_tex= VGroup(*[Tex(key, color= BLACK, font_size= 10) for key in keys]).arrange(DOWN, aligned_edge= LEFT, buff= 0.1)
...
class Example_Eq_Action(Scene):
    def construct(self):
        ...
        keys_tex= VGroup(*[Tex(key, color= BLACK, font_size= 15) for key in keys]).arrange(DOWN, aligned_edge= LEFT, buff= 0.1)
...
class Example_Eq_Junc(Scene):
    def construct(self):
        ...
        keys_tex= VGroup(*[Tex(key, color= BLACK, font_size= 20) for key in keys]).arrange(DOWN, aligned_edge= LEFT, buff= 0.1)
...
class Example_Eq_GC(Scene):
    def construct(self):
        ...
        keys_tex= VGroup(*[Tex(key, color= BLACK, font_size= 5) for key in keys]).arrange(DOWN, aligned_edge= LEFT, buff= 0.1)
...
class Example_Eq_Quantum(Scene):
    def construct(self):
        ...
        keys_tex= VGroup(*[Tex(key, color= BLACK, font_size= 70) for key in keys]).arrange(DOWN, aligned_edge= LEFT, buff= 0.1)
