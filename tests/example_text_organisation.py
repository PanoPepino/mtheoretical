...
class Generic_Slide(Scene):
    def construct(self):
        ...
        ref1= Ref(the_dictionary= 'example_refeq/dictionaries/test_ref.txt', the_ref= 'RS1').to_corner(UR)
...
class Example_Equation(Scene):
    def construct(self):
        eq_show= Eq_General(the_dictionary= 'example_refeq/dictionaries/eq_test_file.txt', the_equation= 'my_other_eq_2')
        self.add(eq_show)
