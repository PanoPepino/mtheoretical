...
class Eq_General(VGroup):
    ...
    def __init__(self,
        ...
        my_path= split_dictionary_path(the_dictionary)[0] # Uses function in refeq_funcs to split the relative path
        ...
        if the_equation in load_the_dic:
            self.chosen_equation= MathTex(load_the_dic[the_equation], font_size= text_size, color= text_color)
